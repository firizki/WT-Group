CREATE DATABASE  IF NOT EXISTS `food_sharing` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `food_sharing`;
-- MySQL dump 10.13  Distrib 8.0.26, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: food_sharing
-- ------------------------------------------------------
...
-- Dump completed on 2022-07-26 19:40:03
